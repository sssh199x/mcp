 ...
 */
server.tool("get_project_overview", "Get comprehensive overview of the Learning Notebook Angular project including architecture, tech stack, and current status", {}, async () => {
 ...
 */
server.tool("read_file", "Read any file from the Learning Notebook project with full content and contextual understanding", {
 ...
 */
server.tool("search_codebase", "Search through the Learning Notebook project files for specific patterns, text, or code snippets with context", {
 ...
 */
server.tool("analyze_angular_architecture", "Analyze the Angular project architecture including components, services, routing, data models, and development patterns", {
 ...
 */
server.tool("get_ui_components", "Get detailed information about all UI components in the Learning Notebook component library including props, variants, and usage examples", {
 ...
 */
server.tool("get_design_tokens", "Get comprehensive information about the Tailwind v4 design system including colors, typography, spacing, and CSS custom properties used in the Learning Notebook project", {
 ...
 */
server.tool("analyze_component_usage", "Analyze how components are used throughout the Learning Notebook project, showing usage patterns, import relationships, and architectural insights", {
 ...
 */
server.tool("generate_component_boilerplate", "Generate complete Angular component boilerplate following Learning Notebook patterns and conventions, including TypeScript, HTML, SCSS, README, and test files", {

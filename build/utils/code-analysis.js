 ...
 */
export async function extractFileContext(filePath, fileType) {
    switch (fileType) {
        case 'component':
        case 'service':
        case 'typescript':
 ...
 */
async function parseInterfaceFile(filePath) {
    try {
        const content = await readFile(filePath, 'utf-8');
        return {
            interfaces: extractInterfaces(content),
 ...
 */
export async function analyzeComponentRelationships(projectPath) {

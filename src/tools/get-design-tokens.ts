 ...
 */
function parseDesignTokens(content: string) {
  return {
 ...
 * Parse color tokens
 */
function parseColors(content: string) {
 ...
 * Parse shadow tokens
 */
function parseShadows(content: string) {
  return {
    elevation: {
 ...
 */
function parseTransitions(content: string) {
  return {
    duration: {
 ...
 */
function parseComponentTokens(content: string) {
  return {
    borders: {
      'radius-sm': '0.125rem',
      'radius-md': '0.375rem', 
 ...
 * Parse theme tokens
 */
function parseThemeTokens(content: string) {
  return {
    lightMode: {
      'background': '#ffffff',
      'foreground': '#1f2937',
 ...
 */
function formatDesignTokens(tokens: any, category: string, includeExamples: boolean, format: string): string {
  if (format === "css") {
 ...
 */
function formatAsDetailed(tokens: any, category: string, includeExamples: boolean): string {
 ...
 */
function formatAsReference(tokens: any, category: string): string {
 ...
 * Format as raw CSS
 */
function formatAsCSS(tokens: any, category: string): string {
